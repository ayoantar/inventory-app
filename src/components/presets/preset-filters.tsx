      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-600 rounded-md bg-white/5 dark:bg-white/5 text-brand-primary-text focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      {hasActiveFilters && (
        <div className="flex justify-end mt-4 pt-4 border-t border-gray-700">
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-brand-primary-text hover border border-gray-600 rounded-md hover transition-colors"
          >
            Clear Filters
          </button>
        </div>
