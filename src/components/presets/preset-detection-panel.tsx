  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        >
          <div className="p-2 bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/20 rounded-lg">
      ...
      {/* Preset Matches */}
      {isExpanded && (
        <div className="bg-white/50 dark:bg-white/5/50 backdrop-blur-sm rounded-xl border border-gray-300/50 dark:border-gray-700/50 shadow-sm">
            ...
            {matches.map((match, index) => (
              <div key={match.preset.id} className={`relative overflow-hidden rounded-xl border transition-all duration-200 hover:shadow-md ${
                match.matchPercentage >= 90 
                  ? 'bg-gradient-to-r from-green-50 to-green-100/50 dark:from-green-900/10 dark:to-green-800/5 border-green-200/50 dark:border-green-800/50'
                  : match.matchPercentage >= 70
                  ? 'bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-900/10 dark:to-blue-800/5 border-blue-200/50 dark:border-blue-800/50'
                  : 'bg-gradient-to-r from-orange-50 to-orange-100/50 dark:from-orange-900/10 dark:to-orange-800/5 border-orange-200/50 dark:border-orange-800/50'
              }`}>
                <div className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h4 className="text-lg font-semibold text-gray-900 dark:text-brand-primary-text">
                          {match.preset.name}
                        </h4>
                        ...
                        {match.preset.category && (
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-white/5 dark:text-gray-300">
                            {match.preset.category}
                          </span>
                        )}
                      </div>
                  ...
                  {/* Actions */}
                  <div className="flex items-center space-x-3 pt-3 border-t border-gray-200/50 dark:border-gray-600/50">
                    ...
                    {match.missingItems.length > 0 && (
                      <button
                        ...
                        className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/10 rounded-lg font-medium transition-all duration-200 text-sm"
                      >
                        Add Missing Items
                      </button>
                    )}
                ...
                {match.preset.priority > 0 && (
                  <div className="absolute top-3 right-3">
                    <div className="flex items-center space-x-1 px-2 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 rounded-full text-xs font-medium">
