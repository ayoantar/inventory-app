      ...
      <div className="bg-gray-50 dark:bg-white/5 rounded-lg shadow-xl max-w-md w-full">
        <div className="px-6 py-4 border-b border-gray-300 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-brand-primary-text">Check In Asset</h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4">
          ...
          <div className="flex space-x-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-md text-sm font-medium disabled:opacity-50 transition-colors"
            >
