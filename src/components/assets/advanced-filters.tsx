...
export default function AdvancedFilters({
  ...
  return (
    <div className="bg-gray-50 dark:bg-white/5 rounded-lg shadow border border-gray-300 dark:border-gray-700">
      {/* Header */}
      <div className="p-4 border-b border-gray-300 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-brand-primary-text">Search & Filters</h3>
            {hasActiveFilters && (
          ...
          <button
            onClick={onToggle}
            className="text-gray-800 dark:text-brand-secondary-text hover:text-gray-800 dark:hover:text-brand-primary-text transition-colors"
          >
            <svg
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
                filters.status === 'AVAILABLE'
                  ...
                  : 'bg-white hover:bg-white/10 text-gray-800 dark:bg-white/5 dark:hover:bg-white/10 dark:text-gray-200 border border-gray-300 dark:border-gray-600 shadow-sm'
              }`}
            >
              🟢 Available
            </button>
        ...
        <div className="flex space-x-4">
          ...
          <div className="flex items-end space-x-2">
            ...
            {hasActiveFilters && (
              <button
                onClick={onReset}
                className="text-gray-700 dark:text-brand-secondary-text hover:text-gray-700 dark:hover:text-gray-300 px-4 py-2 text-sm font-medium transition-colors"
              >
                Clear All
              </button>
            )}
      ...
      {/* Advanced Filters */}
      {isExpanded && (
        <div className="p-4 border-t border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-white/5/50">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-white/5 text-gray-900 dark:text-brand-primary-text focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
              >
            ...
            <div className="md:col-span-2 lg:col-span-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="Min $"
                  className="w-full min-w-0 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-white/5 text-gray-900 dark:text-brand-primary-text placeholder-gray-600 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <span className="text-gray-700 dark:text-brand-secondary-text text-sm flex-shrink-0">to</span>
                <input
                  type="number"
                  min="0"
                  step="0.01"
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center space-x-1">
                <input
                  ...
                  className="flex-1 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-white/5 text-gray-900 dark:text-brand-primary-text focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <span className="text-gray-700 dark:text-brand-secondary-text text-sm px-1 flex-shrink-0">to</span>
                <input
                  type="date"
