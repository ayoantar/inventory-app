      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl border border-gray-300/50 dark:border-gray-700/50 shadow-xl shadow-gray-200/20 dark:shadow-gray-900/50 p-8 sticky top-6 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/30 dark:hover:shadow-gray-900/60">
              {/* Mode Toggle */}
              <div className="mb-8">
                ...
                <div className="bg-white/80 dark:bg-white/5 rounded-xl p-1.5 border border-gray-200 dark:border-gray-600">
                  <button
                    ...
                    className={`flex-1 px-6 py-4 text-sm font-semibold rounded-lg transition-all duration-200 flex items-center justify-center w-full ${
                      scanMode === 'CHECK_OUT'
                        ...
                        : 'text-gray-800 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white dark:hover:bg-white/10/50'
                    }`}
                  >
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Add Items</h3>
                </div>
                ...
                <form onSubmit={handleManualSearch} className="space-y-5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="relative w-full pl-12 pr-14 py-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white/80 dark:bg-white/5 text-gray-900 dark:text-brand-primary-text placeholder-gray-600 dark:placeholder-gray-400 focus:outline-none focus:border-blue-500/50 dark:focus:border-blue-400/50 focus:bg-white dark:focus:bg-gray-800 transition-all duration-200 shadow-sm focus:shadow-lg text-base font-medium text-center"
                      autoFocus
                    />
                    ...
                    <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                      <button
                        ...
                        className="p-1 text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-all duration-200 transform hover:scale-110"
                  ...
                  <div className="text-center">
                    <p className="text-xs text-gray-700 dark:text-brand-secondary-text leading-relaxed">
                ...
                {/* Status Messages */}
                {error && (
                  <div className="p-4 bg-gradient-to-r from-red-50 to-red-100/50 dark:from-red-900/20 dark:to-red-800/10 border border-red-200 dark:border-red-800 rounded-xl shadow-sm animate-in slide-in-from-top-2 duration-300">
                    <p className="text-sm text-red-800 dark:text-red-200 flex items-center font-medium">
                ...
                {success && (
                  <div className="p-4 bg-gradient-to-r from-green-50 to-green-100/50 dark:from-green-900/20 dark:to-green-800/10 border border-green-200 dark:border-green-800 rounded-xl shadow-sm animate-in slide-in-from-top-2 duration-300">
                    <p className="text-sm text-green-800 dark:text-green-200 flex items-center font-medium">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl border border-gray-300/50 dark:border-gray-700/50 shadow-xl shadow-gray-200/20 dark:shadow-gray-900/50 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/30 dark:hover:shadow-gray-900/60">
              {/* Header */}
              <div className="p-8 border-b border-gray-300/50 dark:border-gray-700/50">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center space-x-3 mb-2">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
                    ...
                    <p className="text-sm text-gray-800 dark:text-gray-400 ml-5">
                      {checkOutItems.length > 0 && (
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300 mr-2">
                  ...
                  {state.items.length > 0 && (
                    <button
                      onClick={clearCart}
                      className="px-6 py-3 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all duration-200 text-sm font-semibold shadow-sm hover:shadow-md transform hover:scale-[1.02] border border-red-200 dark:border-red-800"
                    >
                      Clear All
                    </button>
                  )}
              ...
              <div className="p-8">
                {state.items.length === 0 ? (
                  <div className="text-center py-16">
                    <div className="w-24 h-24 mx-auto bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-2xl flex items-center justify-center mb-6">
                      <svg className="w-12 h-12 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent mb-3">Ready to scan</h3>
                    <p className="text-gray-800 dark:text-gray-400 max-w-sm mx-auto leading-relaxed">
                  ...
                  <div className="space-y-6">
                    ...
                    {checkOutItems.length > 0 && (
                      <div>
                        ...
                        <div className="bg-gradient-to-r from-orange-50/30 to-orange-100/20 dark:from-orange-900/10 dark:to-orange-800/5 rounded-xl border border-orange-200/50 dark:border-orange-800/50 overflow-hidden">
                          {checkOutItems.map((item, index) => (
                            <div key={item.assetId} className={`flex items-center justify-between p-4 hover:bg-orange-50/50 dark:hover:bg-orange-900/20 transition-all duration-200 ${index !== checkOutItems.length - 1 ? 'border-b border-orange-200/30 dark:border-orange-800/30' : ''}`}>
                              <div className="flex items-center space-x-4 flex-1 min-w-0">
                                ...
                                <div className="flex-shrink-0">
                                  {item.asset.imageUrl ? (
                                    <img
                                      ...
                                      className="w-12 h-12 object-cover rounded-lg border border-orange-200 dark:border-orange-700"
                                    />
                                  ) : (
                                    <div className="w-12 h-12 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-800 dark:to-orange-900 rounded-lg flex items-center justify-center border border-orange-200 dark:border-orange-700">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="mb-2">
                                    <h4 className="font-semibold text-gray-900 dark:text-brand-primary-text text-base mb-1">
                                      {item.asset.name}
                                    </h4>
                                    {item.asset.description && (
                                      <p className="text-xs text-gray-600 dark:text-gray-400 overflow-hidden leading-relaxed" style={{
                                        display: '-webkit-box',
                                        WebkitLineClamp: 2,
                                  ...
                                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-800 dark:text-gray-400">
                                    ...
                                    {(item.asset.currentValue || item.asset.purchasePrice) && (
                                      <span className="flex items-center font-medium text-orange-700 dark:text-orange-400 col-span-2">
                                ...
                                <div className="flex items-center space-x-2 flex-shrink-0">
                                  ...
                                  <button
                                    ...
                                    className="text-red-400 hover:text-red-600 dark:hover:text-red-400 p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 transform hover:scale-110"
                    ...
                    {checkInItems.length > 0 && (
                      <div>
                        ...
                        <div className="bg-gradient-to-r from-green-50/30 to-green-100/20 dark:from-green-900/10 dark:to-green-800/5 rounded-xl border border-green-200/50 dark:border-green-800/50 overflow-hidden">
                          {checkInItems.map((item, index) => (
                            <div key={item.assetId} className={`flex items-center justify-between p-4 hover:bg-green-50/50 dark:hover:bg-green-900/20 transition-all duration-200 ${index !== checkInItems.length - 1 ? 'border-b border-green-200/30 dark:border-green-800/30' : ''}`}>
                              <div className="flex items-center space-x-4 flex-1 min-w-0">
                                {/* Asset Image/Icon */}
                                <div className="flex-shrink-0">
                                  {item.asset.imageUrl ? (
                                    <img
                                      src={item.asset.imageUrl}
                                      alt={getAssetDisplayName(item.asset)}
                                      className="w-12 h-12 object-cover rounded-lg border border-green-200 dark:border-green-700"
                                    />
                                  ) : (
                                    <div className="w-12 h-12 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-800 dark:to-green-900 rounded-lg flex items-center justify-center border border-green-200 dark:border-green-700">
                                      <span className="text-lg">📦</span>
                                    </div>
                                  )}
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-800 dark:text-gray-400">
                                    ...
                                    {(item.asset.currentValue || item.asset.purchasePrice) && (
                                      <span className="flex items-center font-medium text-green-700 dark:text-green-400 col-span-2">
              ...
              {/* Footer */}
              {state.items.length > 0 && (
                <div className="p-8 border-t border-gray-300/50 dark:border-gray-700/50 bg-gradient-to-r from-gray-50/50 to-gray-100/30 dark:from-gray-700/30 dark:to-gray-800/50 backdrop-blur-sm">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-800 dark:text-gray-400">
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span>
                          <span className="font-semibold text-gray-900 dark:text-brand-primary-text text-lg">{state.items.length}</span>
