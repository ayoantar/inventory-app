    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-slate-50 to-indigo-50/20 dark:from-brand-dark-blue dark:via-brand-dark-blue-deep dark:to-brand-black">
      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-brand-primary-text dark:to-brand-secondary-text bg-clip-text text-transparent">
                    Maintenance
                  </h1>
                </div>
          ...
          {/* Filters */}
          <div className="bg-white/80 dark:bg-white/5 rounded-lg shadow-sm border border-gray-300 dark:border-gray-700 p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <label htmlFor="search" className="block text-sm font-medium text-gray-700 dark:text-brand-secondary-text mb-1">
                  Search
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="status" className="block text-sm font-medium text-gray-700 dark:text-brand-secondary-text mb-1">
                  Status
                </label>
                <select
                  id="status"
              ...
              <div>
                <label htmlFor="type" className="block text-sm font-medium text-gray-700 dark:text-brand-secondary-text mb-1">
                  Type
                </label>
                <select
                  id="type"
              ...
              <div className="flex items-end">
                {Object.values(filters).some(value => value !== '') && (
                  <button
                    ...
                    className="w-full bg-gray-100 hover:bg-white/10 text-gray-700 dark:bg-brand-dark-blue dark:hover:bg-brand-dark-blue-deep dark:text-brand-secondary-text px-4 py-2 rounded-md text-sm font-medium transition-colors"
                  >
                    Clear Filters
                  </button>
                )}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 dark:border-brand-dark-blue-deep rounded-md hover:bg-white/10 dark:hover:bg-brand-dark-blue-deep bg-white/80 dark:bg-white/5 text-gray-900 dark:text-brand-primary-text disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  Previous
                </button>
                
                <span className="px-3 py-2 text-sm border border-gray-300 dark:border-brand-dark-blue-deep rounded-md bg-white/80 dark:bg-brand-dark-blue text-slate-700 dark:text-brand-secondary-text">
          ...
          {maintenanceRecords.length === 0 && !loading && (
            <div className="text-center py-12">
              <svg className="mx-auto h-12 w-12 text-gray-400 dark:text-brand-secondary-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4" />
              </svg>
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-brand-primary-text">No maintenance records found</h3>
