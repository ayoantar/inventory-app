    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-slate-50 to-indigo-50/20 dark:from-brand-dark-blue dark:via-gray-925 dark:to-brand-black">
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          {/* Basic Information */}
          <div className="bg-gray-900/5/80 backdrop-blur-sm rounded-2xl border border-gray-300/50 shadow-xl shadow-gray-200/20 p-8">
          ...
          <div className="bg-gray-900/5/80 backdrop-blur-sm rounded-2xl border border-gray-300/50 shadow-xl shadow-gray-200/20 p-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-brand-primary-text flex items-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                Preset Items
              </h2>
              <button
                type="button"
                onClick={addItem}
                className="inline-flex items-center px-4 py-2 bg-purple-600 hover text-white rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02]"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
            ...
            <div className="space-y-4">
              {items.map((item, index) => (
                <div key={item.tempId} className="bg-white/5 dark:bg-white/5 hover:bg-white/10 dark:hover:bg-white/10 rounded-xl p-4 border border-gray-200/50 transition-colors">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 border border-gray-600 rounded-lg bg-gray-900 text-brand-primary-text focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-200"
                    ...
                    <div className="flex items-end justify-between">
                      ...
                      {items.length > 1 && (
                        <button
                          ...
                          className="text-red-500 hover p-1 rounded transition-colors"
                        >
          ...
          <div className="bg-gray-900/5/80 backdrop-blur-sm rounded-2xl border border-gray-300/50 shadow-xl shadow-gray-200/20 p-8">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={4}
              className="w-full px-4 py-3 border border-gray-600 rounded-lg bg-gray-900 text-brand-primary-text focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-200"
          ...
          <div className="flex items-center justify-end space-x-4">
            <Link
              href="/presets"
              className="px-6 py-3 border border-gray-600 text-gray-300 hover rounded-xl font-medium transition-all duration-200"
            >
              Cancel
            </Link>
            <button
