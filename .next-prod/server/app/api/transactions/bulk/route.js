        ...
        <td style="padding: 16px; vertical-align: top;">
          <div style="display: flex; align-items: flex-start;">
            ...
            <div>
              ...
              <p style="margin: 4px 0; color: #6b7280; font-size: 14px;">Category: ${"object"==typeof a.category&&a.category?a.category.name:(a.category||"No Category").replace(/_/g," ")}</p>
...
`,d.forEach((a,b)=>{let c=a.currentValue||a.purchasePrice;h+=`${b+1}. ${a.name}
   Category: ${"object"==typeof a.category&&a.category?a.category.name:(a.category||"No Category").replace(/_/g," ")}
...
\xa9 ${new Date().getFullYear()} LightSail VR. All rights reserved.`}({transactionType:a,userName:b,userEmail:c,assets:f,transactionDate:g,totalValue:h});return await (0,e.ZM)({to:c,subject:`${"CHECKOUT"===a?"Checkout":"Check-in"} Confirmation - LSVR Inventory`,html:i,text:j})}catch(a){return console.error("Error sending transaction email:",a),{success:!1,error:a}}}}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[2073,5491,2190,9526,2539,8275],()=>b(b.s=77350));module.exports=c})();